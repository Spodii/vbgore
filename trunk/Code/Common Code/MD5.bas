...
'More info: http://www.vbgore.com/CommonCode.MD5.MD5_File
'*****************************************************************
...
'More info: http://www.vbgore.com/CommonCode.MD5.MD5_String
'*****************************************************************
Dim udtContext As MD5_CONTEXT
Dim bytDigest(15) As Byte
Dim bytData() As Byte
...
'*****************************************************************
'Converts a MD5 digest to a valid string
'More info: http://www.vbgore.com/CommonCode.MD5.MD5_DigestToString
'*****************************************************************
Dim lngI As Long
...
'More info: http://www.vbgore.com/CommonCode.MD5.MD5_StringToArray
'*****************************************************************
