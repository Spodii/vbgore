...
'*****************************************************************
'Initializes the connection to MySQL and loads all related MySQL values from Server.ini
'More info: http://www.vbgore.com/CommonCode.MySQL.MySQL_Init
'*****************************************************************
...
'*****************************************************************
'Sets the server value of all users to 0
'More info: http://www.vbgore.com/CommonCode.MySQL.MySQL_RemoveOnline
'*****************************************************************
...
'More info: http://www.vbgore.com/CommonCode.MySQL.MySQL_Optimize
'*****************************************************************
