...
'g1 = (g1 * a) + (g2 - (g2 * (a / 255)))
'b1 = (b1 * a) + (b2 - (b2 * (a / 255)))
Const Alpha As Single = (255 - 125) / 255    '100 is the alpha value of the grid
Const Add As Single = (255 - (255 * Alpha))
    ...
    If frmMain.GrhLst.ListIndex > -1 Then DrawSelectedGrh frmMain.GrhLst.List(frmMain.GrhLst.ListIndex), vbRed
    If frmMain.OldGrhLst.ListIndex > -1 Then DrawSelectedGrh frmMain.OldGrhLst.List(frmMain.OldGrhLst.ListIndex), vbGreen
