...
'*****************************************************************
'Updates a NPC's mod stats
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_UpdateModStats
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AI_Attack
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AI_AttackNPC
'*****************************************************************
Dim Damage As Long
Dim HeadingLoop As Long
Dim nPos As WorldPos
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AI
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AI_ClosestChar
'*****************************************************************
Dim tX As Integer
Dim tY As Integer
Dim X As Integer
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AI_ClosestPC
'*****************************************************************
Dim tX As Integer
Dim tY As Integer
Dim X As Integer
...
'*****************************************************************
'Return the index of the closest player character (PC)
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AI_ClosestNPC
'*****************************************************************
Dim tX As Integer
Dim tY As Integer
Dim X As Integer
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AttackNPC
'*****************************************************************
Dim HitRate As Long
Dim Hit As Long
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AttackUser_ApplyDamage
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_AttackUser
'*****************************************************************
Dim HitRate As Long
Dim Hit As Long
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_ChangeChar
'*****************************************************************
...
'*****************************************************************
'Closes a NPC
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_Close
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_CleanArray
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_ChangeMP
'*****************************************************************
Dim MPA As Byte
Dim MPB As Byte
...
'To lower a NPC's HP, use NPC_Damage
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_Heal
'*****************************************************************
Dim HPA As Byte
Dim HPB As Byte
...
'To raise a NPC's HP, use NPC_Heal
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_Heal
'*****************************************************************
Dim NewSlot As Byte
Dim NewX As Byte
...
'*****************************************************************
'Kill a NPC
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_Kill
'*****************************************************************
Dim Slot As Byte
Dim i As Byte
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_MakeChar
'*****************************************************************
Dim SndHP As Byte
Dim SndMP As Byte
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_MoveChar
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_NextOpen
'*****************************************************************
...
'*****************************************************************
'Re-spawns a NPC that has died
'More info: http://www.vbgore.com/GameServer.NPCs.NPC_Spawn
'*****************************************************************
