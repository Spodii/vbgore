...
'More info: http://www.vbgore.com/GameServer.Groups.Group_AddUser
'*****************************************************************
Dim i As Byte
...
'More info: http://www.vbgore.com/GameServer.Groups.Group_EXPandGold
'*****************************************************************
...
'More info: http://www.vbgore.com/GameServer.Groups.Group_RemoveUser
'*****************************************************************
Dim i As Byte
Dim j As Byte
...
'*****************************************************************
'Finds the next free group index and returns it, along with allocates
'the memory needed for the new group
'More info: http://www.vbgore.com/GameServer.Groups.Group_Create
'*****************************************************************
Dim i As Byte
